    ...
    <Mainlayout>
      <div className="">
        <div className="w-full storebg">
          <div className="px-2 pt-[15rem]">
            <div className="text-center">
              <h1 className="text-white font-semibold xl:text-[5.8rem] lg:text-[6rem] md:text-[7rem] sm:text-[8rem] text-[4rem]">
                Check out our Aso-oke hub
              </h1>
            </div>
            <div onClick={() => navigate("/hub")} className="text-center pt-6">
        ...
        <div className="pt-10">
          <div className="">
            <div className="text-center">
              <h1 className="text-4xl sm:text-[3rem]  font-semibold">
                Our Services
              </h1>
            </div>
            <div className=" xl:px-[18rem] sm:px-4 px-2 py-14 grid grid-cols-2 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-2 gap-10">
              {service?.map((service) => (
        ...
        <div className="bg-[#d4a473]">
          <div className="py-[4rem] ">
            <div className="text-center">
              <h1 className="text-4xl sm:text-[3rem] font-semibold">About</h1>
            </div>
          </div>
        </div>
      </div>
